  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 font-semibold text-xs transition-colors focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        info: "border-transparent bg-blue-100 text-blue-800 shadow-sm hover:bg-blue-100/80",
        success:
          "border-transparent bg-green-100 text-success-800 shadow-sm hover:bg-success-100/80"
      }
    },
    defaultVariants: {
      variant: "default"
